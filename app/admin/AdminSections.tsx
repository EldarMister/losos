...
const withdrawalLabels: Record<CoinWithdrawalStatus, string> = { pending: "Ожидает решения", submitted: "Перевод отправлен", withdrawn: "Завершён", failed: "Отклонён", cancelled: "Отменён клиентом" };
const withdrawalStyles: Record<CoinWithdrawalStatus, string> = { pending: "bg-amber-50 text-amber-800", submitted: "bg-blue-50 text-blue-700", withdrawn: "bg-emerald-50 text-emerald-700", failed: "bg-red-50 text-red-700", cancelled: "bg-slate-100 text-slate-700" };
